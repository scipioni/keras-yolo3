...
#if args.graph_def:
pbtxt = args.output_model_file.replace('.pb','.pbtxt')
tf.train.write_graph(sess.graph.as_graph_def(), '', pbtxt, as_text=True)
print('saved the graph definition in ascii format at: ', pbtxt)
